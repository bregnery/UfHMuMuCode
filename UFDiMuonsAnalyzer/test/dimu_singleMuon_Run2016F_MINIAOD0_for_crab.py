...
print "Sample Name:    " +  "singleMuon_Run2016F_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2016F-PromptReco-v1/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_Run2016F_MINIAOD"+".root") )
