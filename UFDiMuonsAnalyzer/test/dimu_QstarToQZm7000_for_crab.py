...
print "Sample Name:    " +  "QstarToQZm7000"
print "Sample DAS DIR: " +  "/QstarToQZ_M-7000_TuneCUETP8M1_13TeV-pythia8/RunIISpring16MiniAODv2-PUSpring16RAWAODSIM_reHLT_80X_mcRun2_asymptotic_v14-v1/MINIAODSIM"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"QstarToQZm7000"+".root") )
