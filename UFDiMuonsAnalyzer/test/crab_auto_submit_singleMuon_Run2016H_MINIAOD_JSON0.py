...
config.General.requestName = 'singleMuon_Run2016H_MINIAOD_JSON0'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'dimu_singleMuon_Run2016H_MINIAOD0_for_crab.py'
#config.JobType.outputFiles = ['outputfile.root']

config.Data.inputDataset = '/SingleMuon/Run2016G-PromptReco-v2/MINIAOD'
...
config.Data.outputDatasetTag = 'singleMuon_Run2016H_MINIAOD_JSON0'
