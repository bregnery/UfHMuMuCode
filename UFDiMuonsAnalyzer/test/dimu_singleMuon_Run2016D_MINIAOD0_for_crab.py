...
print "Sample Name:    " +  "singleMuon_Run2016D_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2016D-PromptReco-v2/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_Run2016D_MINIAOD"+".root") )
