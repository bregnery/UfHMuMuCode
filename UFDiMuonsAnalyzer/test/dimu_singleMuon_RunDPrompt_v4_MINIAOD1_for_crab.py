...
print "Sample Name:    " +  "singleMuon_RunDPrompt_v4_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2015D-PromptReco-v4/MINIAOD"
if thisIsData:
    print "Sample JSON:    " +  "sample_file_lists/data/json/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt"
print ""
...
if thisIsData:
    ...
    process.source.lumisToProcess = LumiList.LumiList(filename = "sample_file_lists/data/json/Cert_246908-260627_13TeV_PromptReco_Collisions15_25ns_JSON_v2.txt").getVLuminosityBlockRange()
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_RunDPrompt_v4_MINIAOD"+".root") )
