...
print "Sample Name:    " +  "singleMuon_Run2016C_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2016C-PromptReco-v2/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_Run2016C_MINIAOD"+".root") )
