...
print "Sample Name:    " +  "singleMuon_Run2016G_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2016G-PromptReco-v1/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_Run2016G_MINIAOD"+".root") )
