...
print "Sample Name:    " +  "singleMuon_RunDOct_v1_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2015D-05Oct2015-v1/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_RunDOct_v1_MINIAOD"+".root") )
