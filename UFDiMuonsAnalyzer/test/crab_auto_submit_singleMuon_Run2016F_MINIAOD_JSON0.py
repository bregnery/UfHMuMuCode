...
config.General.requestName = 'singleMuon_Run2016F_MINIAOD_JSON0'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'dimu_singleMuon_Run2016F_MINIAOD0_for_crab.py'
...
config.Data.outputDatasetTag = 'singleMuon_Run2016F_MINIAOD_JSON0'
