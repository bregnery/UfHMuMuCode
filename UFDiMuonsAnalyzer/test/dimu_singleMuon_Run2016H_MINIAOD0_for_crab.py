...
print "Sample Name:    " +  "singleMuon_Run2016H_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2016G-PromptReco-v2/MINIAOD"
if thisIsData:
    print "Sample JSON:    " +  "sample_file_lists/data/json/Cert_271036-280385_13TeV_PromptReco_Collisions16_JSON_NoL1T_v2.txt"
print ""
...
if thisIsData:
    ...
    process.source.lumisToProcess = LumiList.LumiList(filename = "sample_file_lists/data/json/Cert_271036-280385_13TeV_PromptReco_Collisions16_JSON_NoL1T_v2.txt").getVLuminosityBlockRange()
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_Run2016H_MINIAOD"+".root") )
