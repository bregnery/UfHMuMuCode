...
print "Sample Name:    " +  "singleMuon_Run2016B_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2016B-PromptReco-v2/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_Run2016B_MINIAOD"+".root") )
