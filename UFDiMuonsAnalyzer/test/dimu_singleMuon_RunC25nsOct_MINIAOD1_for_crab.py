...
print "Sample Name:    " +  "singleMuon_RunC25nsOct_MINIAOD"
print "Sample DAS DIR: " +  "/SingleMuon/Run2015C_25ns-05Oct2015-v1/MINIAOD"
if thisIsData:
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("stage_1_"+"singleMuon_RunC25nsOct_MINIAOD"+".root") )
